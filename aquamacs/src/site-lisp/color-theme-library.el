...
(defun color-theme-tiger-xcode ()
  ...
  (color-theme-install
   '(color-theme-tiger-xcode
     ...
     (font-lock-comment-face ((t (:foreground "#236e25"))))
     (font-lock-constant-face ((t (:foreground "#000000"))))
     (font-lock-doc-face ((t (:foreground "#236e25"))))
     (font-lock-doc-string-face ((t (:foreground "#236e25"))))
     (font-lock-function-name-face ((t (:foreground "#000000"))))
     (font-lock-keyword-face ((t (:foreground "#760f50"))))
     (font-lock-preprocessor-face ((t (:foreground "#683821"))))
     (font-lock-reference-face ((t (:foreground "#000000"))))
     (font-lock-string-face ((t (:foreground "#891315"))))
     (font-lock-type-face ((t (:foreground "#760f50"))))
     (font-lock-variable-name-face ((t (:foreground "#760f50"))))
     (font-lock-warning-face ((t (:bold t :foreground "Red" :weight bold))))
     (fringe ((t (:background "grey95"))))
     (gnus-cite-attribution-face ((t (:italic t :slant italic))))
     (gnus-cite-face-1 ((t (:foreground "MidnightBlue"))))
     ...
     (modeline-mousable-minor-mode ((t (:background "grey75" :foreground "black" :box (:line-width -1 :style released-button)))))
     (mouse ((t (:background "black"))))
     (primary-selection ((t (:background "#c7d0db"))))
     (reb-match-0 ((t (:background "lightblue"))))
     (reb-match-1 ((t (:background "aquamarine"))))
     (reb-match-2 ((t (:background "springgreen"))))
     (reb-match-3 ((t (:background "yellow"))))
