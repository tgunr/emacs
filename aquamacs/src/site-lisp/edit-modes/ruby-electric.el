...
;;
;;; Aquamacs-Update-From http://cvs.sourceforge.jp/cgi-bin/viewcvs.cgi/*checkout*/macemacsjp/CarbonEmacsPackage/GPL/ruby-mode/ruby-electric.el?rev=HEAD&content-type=text/plain
;;
