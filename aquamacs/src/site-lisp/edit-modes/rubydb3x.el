;;; Aquamacs-Update-From http://cvs.sourceforge.jp/cgi-bin/viewcvs.cgi/*checkout*/macemacsjp/CarbonEmacsPackage/GPL/ruby-mode/rubydb3x.el?rev=HEAD&content-type=text/plain
...
and source-file directory for your debugger."
  ...
  (if (not (fboundp 'gud-overload-functions))
    ...
    ;; patched by dr. 10/2005 - untested
    (gud-common-init command-line rubydb-command-name 'gud-rubydb-marker-filter))
