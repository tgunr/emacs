...
;; Copyright (C) 2005-2011, 2017 David Reitter
...
(define-key-after menu-bar-edit-menu [copy-formatted]
  `(menu-item "Copy Formatted"
      copy-formatted
      :enable mark-active
      :help "Copy selected text in region as formatted text")
  'copy)
(define-key-after menu-bar-edit-menu [copy-pdf]
  `(menu-item "Copy as PDF"
      copy-as-pdf
      :enable mark-active
      :help "Copy selected text in region as formatted PDF")
  'copy)
...
(autoload 'copy-formatted "mac-print" "Copy the region formatted into the clipboard." 'interactive nil)
(autoload 'copy-as-pdf "mac-print" "Copy the region in PDF format into the clipboard." 'interactive nil)
